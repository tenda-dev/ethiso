...
public class DynamicBytesTypeConverterFactory implements TypeConverterFactory<byte[]> {

	private static final String BYTES = "bytes";
	private static final TypeConverter<byte[]> INSTANCE = new DynamicBytesTypeConverter();
