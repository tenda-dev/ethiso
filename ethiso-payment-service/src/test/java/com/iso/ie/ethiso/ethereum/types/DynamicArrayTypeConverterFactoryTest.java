...
public class DynamicArrayTypeConverterFactoryTest {
	...
	public void uint8Array2() {
		assertNotNull(getTypeConverter("uint8[]"));
	}
	...
	private TypeConverter<?> getTypeConverter(final String type) {
		return new DynamicArrayTypeConverterFactory<>().newTypeConverter(TYPE_CONVERTER_MANAGER, type);
	}
}