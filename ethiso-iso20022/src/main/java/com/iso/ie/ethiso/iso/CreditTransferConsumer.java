...
import com.iso.ie.ethiso.iso.domain.CodeOrProprietary;
import com.iso.ie.ethiso.iso.domain.CreditTransfer;
import com.iso.ie.ethiso.iso.domain.CreditTransferStatus;
import com.iso.ie.ethiso.iso.domain.PaymentId;
import com.iso.ie.ethiso.iso.domain.Status;
import com.iso.ie.ethiso.iso.domain.StatusReasonInfo;
